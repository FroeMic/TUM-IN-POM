...
*"...At the end of the project we are providing the best software running on a new, faster and fully functional server. In addition, all of the existing data, in an optimal way, have been moved from the old server to the new. All of the current functionality still exist. Access to the system...."*
